    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">User Id</label>
                    ...
                    <label className="text-sm text-primary">Compan Id</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.companId}</p></div>
                    <label className="text-sm text-primary">Effective Date</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.effectiveDate}</p></div>
