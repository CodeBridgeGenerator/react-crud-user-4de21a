...
const TeamsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info teams created successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="teams-create-dialog-component">
            <div>
            ...
            <div>
                <p className="m-0">User Ids:</p>
                <InputText className="w-full mb-3" value={_entity?.userIds} onChange={(e) => setValByKey("userIds", e.target.value)}  />
            </div>
            <div>
