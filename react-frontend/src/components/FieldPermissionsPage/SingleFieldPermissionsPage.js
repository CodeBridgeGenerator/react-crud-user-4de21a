    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">Role Id</label>
                    ...
                    <label className="text-sm text-primary">Patchany</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.patchany}</p></div>
                    <label className="text-sm text-primary">Patchown</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.patchown}</p></div>
