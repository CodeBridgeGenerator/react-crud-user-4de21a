    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            ...
            <label className="text-sm text-primary">User Id</label>
                    ...
                    <label className="text-sm text-primary">Position Id</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.positionId}</p></div>
                    ...
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.start}</p></div>
                    <label className="text-sm text-primary">End</label>
                    <div className="ml-3"><p className="m-0 ml-3" >{_entity?.end}</p></div>
